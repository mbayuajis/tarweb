        ...
        <table class="table striped hovered border bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $peminjam->getJadwal->waktu }}</td>
                    <td>{{ $peminjam->status }}</td>
                    <td>
                        <div class="inline-block">
                            <button class="button mini-button dropdown-toggle">Aksi</button>
                            <ul class="split-content d-menu" data-role="dropdown">
                                <li><a href="pinjamsetuju/{{ $peminjam->id }}"><span class="mif-zoom-in"></span> Setujui</a></li>
                                <li><a href=""><span class="mif-pencil"></span> Edit</a></li>
                                <li><a href="peminjaman/{{ $peminjam->id }}/delete"><span class="mif-cross"></span> Delete</a></li>
                            </ul>
                        </div>
                    </td>
                </tr>
